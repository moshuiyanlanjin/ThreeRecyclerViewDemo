...
public class TreeHelper {
     ...
     * @throws IllegalArgumentException
     */
    private static <T> List<Node> convetData2Node(List<T> datas) throws IllegalAccessException, IllegalArgumentException {
        ...
        for (T t : datas) {
            ...
            for (Field f : declaredFields) {
                ...
                if (f.getAnnotation(ThrrNodePid.class) != null) {
                    f.setAccessible(true);
                    pId = f.getInt(t);
                }
                ...
                if(f.getAnnotation(TreeNodeTier.class) != null){
                    f.setAccessible(true);
                    tire = f.getInt(t);
                }

                if (id != -1 && pId != -1 && label != null && tire != -1) {
                    break;
                }
            }
            node = new Node(id, pId, label,t,tire);
            nodes.add(node);
        }
        /**
